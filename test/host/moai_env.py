...
##----------------------------------------------------------------##
ENV_NAME_MOAI_LIB       = 'MOAI_LIB'
ENV_NAME_FMOD_ROOT      = 'FMOD_ROOT'
ENV_NAME_MOAI_SRC_ROOT  = 'MOAI_SRC_ROOT'


##----------------------------------------------------------------##
MOAI_LIB_DEFAULT      = ''#'/Users/tommo/prj/moai/lib'
MOAI_SRC_ROOT_DEFAULT = ''#'/Users/tommo/dev/moai-dev'
FMOD_ROOT_DEFAULT     = ''#'/Users/tommo/dev/fmod'

##----------------------------------------------------------------##
#env path helpers
def setup_moai_env( ctx, target, config ):
	MOAI_LIB  =  os.environ.get( ENV_NAME_MOAI_LIB, MOAI_LIB_DEFAULT )
...
def find_moai_lib_root():
	MOAI_ROOT =  os.environ.get( ENV_NAME_MOAI_SRC_ROOT, MOAI_SRC_ROOT_DEFAULT )
	return MOAI_ROOT
...
def setup_fmod_env( ctx, target, config ):
	FMOD_ROOT = os.environ.get( ENV_NAME_FMOD_ROOT, FMOD_ROOT_DEFAULT )
