...
cdef extern from "moai-sim/host.h" nogil:
	...
	void		AKUSetInputDeviceJoystickEx		( int deviceID, int sensorID, const_char_ptr name )
	...
	void		AKUEnqueueJoystickExButtonEvent		( int deviceID, int sensorID, int buttonID, bint down )
